...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../Controllers/marca.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function(){
    ...
    tabla=$('#usuario_data').dataTable({
        ...
        "ajax":{
            url: '../../Controllers/marca.php?op=listar',
            type : "post",
            dataType : "json",						
            error: function(e){
...
function editar(ID_marca){
    ...
    $.post("../../Controllers/marca.php?op=mostrar", {ID_marca : ID_marca}, function (data) {
...
function eliminar(ID_marca){
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.post("../../Controllers/marca.php?op=eliminar", {ID_marca : ID_marca}, function (data) {
